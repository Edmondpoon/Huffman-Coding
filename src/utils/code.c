...
// returns the top of the code (Last non-zero byte)
//
// c: the code to check
...
// Returns whether you were able to set the bit or not
//
// c: the code to alter
...
// Sets a bit of a Code at a given index position to 1.
// Returns whether you were able to clear the bit or not
//
// c: the code to alter
...
// Returns whether you were able to push the bit or not
//
// bit: the bit to push
...
// Returns whether you were able to pop the bit or not
//
